 ...
 * from UVC
 */
public class UVCTwoViewActivity extends BaseActivity implements CameraDialog.CameraDialogParent{
                ...
                case R.id.camera_view_L:
                    if (mHandlerL != null) {
                        if (!mHandlerL.isOpened()) {
                            CameraDialog.showDialog(UVCTwoViewActivity.this);
                        } else {
                            mHandlerL.close();
                            setCameraButton();
                        }
    ...
    private final OnDeviceConnectListener mOnDeviceConnectListener = new OnDeviceConnectListener() {
        ...
        public void onAttach(final UsbDevice device) {
            ...
            Toast.makeText(UVCTwoViewActivity.this, "USB_DEVICE_ATTACHED", Toast.LENGTH_SHORT).show();
        }
        ...
        public void onDettach(final UsbDevice device) {
            ...
            Toast.makeText(UVCTwoViewActivity.this, "USB_DEVICE_DETACHED", Toast.LENGTH_SHORT).show();
        }
